...
- `DataConstruction`: five-step PMC-MI instruction-construction pipeline and prompts.
...
Install the requirements in the relevant subdirectory and follow its scripts or configuration files. Data are released separately through the versioned [KerwinFu/M3LLM-data-v1.0.0](https://huggingface.co/datasets/KerwinFu/M3LLM-data-v1.0.0) repository. Restricted clinical data are not included in this repository.
