...
@LLMRegistry.register("MedGPT-oss")
class MedGPT_OSS:
    def __new__(cls, model_path: str, args: Any) -> Any:
        from models.MedGPT_OSS.MedGPT_OSS_hf import MedGPT_OSS
        return MedGPT_OSS(model_path, args)

@LLMRegistry.register("Hulu-Med")
class HuluMed:
    def __new__(cls, model_path: str, args: Any) -> Any:
        from models.HuluMed.HuluMed_hf import HuluMed
