...
class HealthGPT:
    def __init__(self,model_path,args):
        ...
        adapter_path = os.environ.get("HEALTHGPT_ADAPTER_PATH") or hf_hub_download(
            repo_id="lintw/HealthGPT-XL32",
            filename="com_hlora_weights_QWEN_32B.bin",
        )
        self.llm = load_weights(self.llm, adapter_path)
