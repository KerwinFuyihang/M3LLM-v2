#!/usr/bin/env python3
"""Step 4: construct single-subimage VQA instructions."""
...
from stages import TEXT_MODEL, load_classification_scores, transform_step4_single
...
def main() -> None:
    ...
    run_pipeline(args, transform_step4_single)
